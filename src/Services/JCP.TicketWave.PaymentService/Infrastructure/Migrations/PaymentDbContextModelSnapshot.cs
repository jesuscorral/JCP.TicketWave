...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JCP.TicketWave.PaymentService.Domain.Models.Payment", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("JCP.TicketWave.PaymentService.Domain.Models.PaymentEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JCP.TicketWave.PaymentService.Domain.Models.PaymentMethod", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JCP.TicketWave.PaymentService.Domain.Models.Refund", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JCP.TicketWave.PaymentService.Domain.Models.Payment", b =>
                {
                    b.HasOne("JCP.TicketWave.PaymentService.Domain.Models.PaymentMethod", "PaymentMethod")
                        .WithMany()
            ...
            modelBuilder.Entity("JCP.TicketWave.PaymentService.Domain.Models.PaymentEvent", b =>
                {
                    b.HasOne("JCP.TicketWave.PaymentService.Domain.Models.Payment", "Payment")
                        .WithMany("Events")
